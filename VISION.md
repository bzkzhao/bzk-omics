...
bzk Omics **is** a semantic index, reasoning, and decision layer over the files, pipelines, and instruments a researcher already uses.

bzk Omics **is not** a pipeline executor, a visualisation suite, a notebook environment, an inventory LIMS, or a public repository. It ingests from those systems and links what they produce.
