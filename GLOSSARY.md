...
**Perseus** — A desktop application for proteomics data analysis, long established as a field standard and freely available. The collaborating group's workflow: log₂ transformation, missing-value filtering, imputation from a normal distribution, and a modified two-sample test.
