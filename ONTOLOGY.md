...
CREATE NODE TABLE Analysis(
  id STRING, label STRING,
  kind STRING,                  -- 'processing' | 'curation'. See §5.2.
  basis STRING,                 -- curation only; enum in §5.2
...
- ~~Q4: How are PRIDE datasets without SDRF handled?~~ Settled 2026-08-06 in favour of curation-as-activity. See §5.2 and invariant I8. Rationale: the configuration alternative violates I5. To be recorded as ADR-0009.
