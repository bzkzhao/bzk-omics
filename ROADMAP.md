...
| Position validation against UniProt | 18/20; both failures were resolver isoform bugs, not data errors | Corrected estimate ~100%. Isoform sequences must be fetched directly, never stripped to canonical |
...
| Sequences amended since the ~2019 search | 1 of 20 (~5%) | I2 justified; ~115 of 2,298 sites at risk of silent position drift |
